...
<body>
    <div class="container">
        <div class="table-wrapper">
            <div class="table-title">
                <div class="row">
                    <div class="col-sm-6">
                        <h2>Gestión de <b>Tipos de Producto</b></h2>
                    </div>
                    <div class="col-sm-6">
            ...
            <div class="modal-content">
                <form>
                    <div class="modal-header">
                        <h4 class="modal-title">Crear Tipo de Producto</h4>
            ...
            <div class="modal-content">
                <form>
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            <label>ID</label>
                            <input id="tipo_producto_edit" type="text" class="form-control" disabled>
                        </div>
                        <div class="form-group">
                            <label>Nombre</label>
                            <input id="nombre_tipo_edit" type="text" class="form-control" required>
                        </div>
                        <div class="form-group">
                            <label>Estado</label>
    ...
    <script>
        $(document).ready(function() {
            ...
            $.ajax({
                url: '<?php echo $server_url; ?>/tipos_productos.php',
                ...
                success: function(response) {
                    ...
                    response.tiposProductos.forEach(function(tipo_producto) {
                        var row = '<tr>' +
                            '<td>' +
                            // '<span class="custom-checkbox">' +
            ...
            $('table').on('click', '.edit', function() {
                ...
                var id_tipo_producto = currentRow.find('td:eq(1)').text();
                var nombre = currentRow.find('td:eq(2)').text();
                var estado = currentRow.find('td:eq(3)').text();



                // Llenar los campos de la modal de edición con los datos del usuario
                $('#editEmployeeModal input[id="tipo_producto_edit"]').val(id_tipo_producto);
                $('#editEmployeeModal input[id="nombre_tipo_edit"]').val(nombre);
            ...
            document.getElementById("editEmployeeModal").addEventListener("submit", function(event) {
                ...
                var nombre = document.getElementById("nombre_tipo_edit").value;
                ...
                xhr.open("POST", "<?php echo $server_url; ?>/tipos_productos.php");
                xhr.setRequestHeader("Content-Type", "application/x-www-form-urlencoded;charset=UTF-8");
                xhr.onload = function() {
                    if (xhr.status === 200) {
                        // Si la respuesta es exitosa, consultar el contenido de la respuesta
                        // var response = JSON.parse(xhr.responseText);
                        if (xhr.responseText == "Tipo de producto actualizado exitosamente") {
            ...
            document.getElementById("addEmployeeModal").addEventListener("submit", function(event) {
                ...
                xhr.onload = function() {
                    ...
                    if (xhr.status === 200) {
                        // Si la respuesta es exitosa, consultar el contenido de la respuesta
                        // var response = JSON.parse(xhr.responseText);
                        if (xhr.responseText == "Tipo de producto creado exitosamente") {
                            // Si la respuesta indica éxito, mostrar el modal de éxito con el mensaje proporcionado por el servidor
                            var successMessage = xhr.responseText;
                            document.getElementById("successModalLabel").innerText = "Se realizo con Éxito";
                            document.getElementById("successMessage").innerText = successMessage;
                ...
                document.getElementById("deleteEmployeeModal").addEventListener("submit", function(event) {
                    ...
                    xhr.onload = function() {
                        ...
                        if (xhr.status === 200) {
                            // Si la respuesta es exitosa, consultar el contenido de la respuesta
                            // var response = JSON.parse(xhr.responseText);
                            if (xhr.responseText == "Tipo de producto eliminado exitosamente") {
                                // Si la respuesta indica éxito, mostrar el modal de éxito con el mensaje proporcionado por el servidor
                                var successMessage = xhr.responseText;
                                document.getElementById("successModalLabel").innerText = "Se realizo con Éxito";
                                document.getElementById("successMessage").innerText = successMessage;
