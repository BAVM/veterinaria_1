...
<body>
    <div class="container">
        <div class="table-wrapper">
            <div class="table-title">
                <div class="row">
                    <div class="col-sm-6">
                        <h2>Gestión de <b>Medodos de pago</b></h2>
                    </div>
                    <div class="col-sm-6">
                        <a href="#addEmployeeModal" class="btn btn-success" data-toggle="modal"><i class="material-icons">&#xE147;</i> <span>Agregar Metodo de Pago</span></a>
            ...
            <div class="modal-content">
                <form>
                    <div class="modal-header">
                        <h4 class="modal-title">Crear Metodo de Pago</h4>
    ...
    <div id="editEmployeeModal" class="modal fade">
        <div class="modal-dialog">
            <div class="modal-content">
                <form>
                    <div class="modal-header">
                        <h4 class="modal-title">Editar Metodo de Pago</h4>
                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                    </div>
                    <div class="modal-body">
                        <div class="form-group">
                            <label>ID</label>
                            <input id="id_metodo_pago" type="text" class="form-control" disabled>
                        </div>
                        <div class="form-group">
                            <label>Nombre</label>
                            <input id="nombre_edit_m_pago" type="text" class="form-control" required>
                        </div>
                        <div class="form-group">
                            <label>Descripción</label>
                            <input id="descripcion_edit_m_pago" type="text" class="form-control" required>
                        </div>
                        <div class="form-group">
                            <label>Estado</label>
    ...
    <div id="deleteEmployeeModal" class="modal fade">
        <div class="modal-dialog">
            <div class="modal-content">
                <form>
                    <div class="modal-header">
                        <h4 class="modal-title">Borrar Metodo de Pago</h4>
                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                    </div>
                    <div class="modal-body">
    ...
    <script>
        $(document).ready(function() {
            ...
            $.ajax({
                url: '<?php echo $server_url; ?>/metodos_pago.php',
            ...
            $('table').on('click', '.edit', function() {
                ...
                var id_metodo_pago = currentRow.find('td:eq(1)').text();
                ...
                $('#editEmployeeModal input[id="id_metodo_pago"]').val(id_metodo_pago);
                $('#editEmployeeModal input[id="nombre_edit_m_pago"]').val(nombre);
                $('#editEmployeeModal input[id="descripcion_edit_m_pago"]').val(descripcion);
            ...
            document.getElementById("editEmployeeModal").addEventListener("submit", function(event) {
                ...
                var id_metodo_pago = document.getElementById("id_metodo_pago").value.trim();
                var firstName = document.getElementById("nombre_edit_m_pago").value.trim();
                var firstDescripcion = document.getElementById("descripcion_edit_m_pago").value.trim();
                var status = document.getElementById("estado_edit").value.trim();

                // Validar que los campos no estén vacíos
                if (firstName === "" || firstDescripcion === "" || status === "") {
                    alert("Por favor, complete todos los campos.");
                    return;
                }

                var formData = new URLSearchParams();
                formData.append('id_metodo_pago', id_metodo_pago);
                formData.append('nombre_metodo', firstName);
                ...
                xhr.open("POST", "<?php echo $server_url; ?>/metodos_pago.php");
                xhr.setRequestHeader("Content-Type", "application/x-www-form-urlencoded;charset=UTF-8");
                xhr.onload = function() {
                    ...
                    if (xhr.status === 200) {
                        ...
                        if (xhr.responseText == "Método de pago actualizado exitosamente") {
            ...
            document.getElementById("addEmployeeModal").addEventListener("submit", function(event) {
                ...
                var firstDescripcion = document.getElementById("descripcion").value;

                // Validar que los campos no estén vacíos
                if (firstName === "" || firstDescripcion === "") {
                    alert("Por favor, complete todos los campos.");
                    return;
                }
                ...
                xhr.onload = function() {
                    ...
                    if (xhr.status === 200) {
                        // Si la respuesta es exitosa, consultar el contenido de la respuesta
                        // var response = JSON.parse(xhr.responseText);
                        if (xhr.responseText == "Método de pago creado exitosamente") {
                            // Si la respuesta indica éxito, mostrar el modal de éxito con el mensaje proporcionado por el servidor
                            var successMessage = xhr.responseText;
                            document.getElementById("successModalLabel").innerText = "Se realizo con Éxito";
                            document.getElementById("successMessage").innerText = successMessage;
                ...
                document.getElementById("deleteEmployeeModal").addEventListener("submit", function(event) {
                    ...
                    xhr.onload = function() {
                        ...
                        if (xhr.status === 200) {
                            // Si la respuesta es exitosa, consultar el contenido de la respuesta
                            // var response = JSON.parse(xhr.responseText);
                            if (xhr.responseText == "Método de pago eliminado exitosamente") {
                                // Si la respuesta indica éxito, mostrar el modal de éxito con el mensaje proporcionado por el servidor
                                var successMessage = xhr.responseText;
                                document.getElementById("successModalLabel").innerText = "Se realizo con Éxito";
                                document.getElementById("successMessage").innerText = successMessage;
